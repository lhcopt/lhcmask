...
def generate_sixtrack_input(mad, seq_name, bb_df, output_folder,
    ...
    if bb_df is not None:
        ...
        if len(sxt_df_4d) > 0:
            ...
            sxt_df_4d['strength-ratio'] = (sxt_df_4d['other_charge_elpb']
        ...
        if len(sxt_df_6d) > 0:
            ...
            sxt_df_6d['strength-ratio'] = (sxt_df_6d['other_charge_elpb']/reference_bunch_charge_sixtrack_ppb)* mad.globals.on_bb_charge
