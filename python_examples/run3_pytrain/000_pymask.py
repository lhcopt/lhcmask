...
def prepare_pytrain_input(mad):
    ...
    pm.match_tune_and_chromaticity(mad,
        ...
        tune_knob1_name=knob_names['qknob_1']['lhcb1'],
        tune_knob2_name=knob_names['qknob_2']['lhcb1'],
        chromaticity_knob1_name=knob_names['chromknob_1']['lhcb1'],
        chromaticity_knob2_name=knob_names['chromknob_2']['lhcb1'],
    ...
    pm.match_tune_and_chromaticity(mad,
        ...
        dq1=configuration['chromaticity_x'],
        dq2=configuration['chromaticity_y'],
        tune_knob1_name=knob_names['qknob_1']['lhcb2'],
        tune_knob2_name=knob_names['qknob_2']['lhcb2'],
        chromaticity_knob1_name=knob_names['chromknob_1']['lhcb2'],
        chromaticity_knob2_name=knob_names['chromknob_2']['lhcb2'],
